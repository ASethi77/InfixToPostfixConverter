// Taken from Building Java Programs' Chapter 14 Case Study (Page 891).
 ...
 * 2*3.8/(4.95-7.8) would be tokenized as 2 * 3.8 / ( 4.95 - 7.8) even though
 * it has no whitespace to separate those tokens.
 */
...
public class StringSplitter {
    ...
    // pre : there is another token to return (throws NoSuchElementException if
    //       not)
